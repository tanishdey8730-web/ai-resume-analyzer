...
/* ════════════════════════════════════════════
   POST /api/analyze
   Body: { resumeText, targetRole?, industry?,
           experience?, resumeType?, jobDesc? }
   Returns: JSON analysis object
════════════════════════════════════════════ */
app.post('/api/analyze', async (req, res) => {
  const {
    resumeText, targetRole = '', industry = '',
    experience = '', resumeType = '', jobDesc = ''
  } = req.body;
...
- keywordScore: judge against ${targetRole || 'the role suggested by the resume'}
